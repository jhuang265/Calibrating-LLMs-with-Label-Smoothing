        ...
        do
            ...
            do
                ...
                do
                    ...
                    if [ ! -f /work/jerry/output-softcap/$softcap/$reduction/$learning_rate/$NAME-$smoothing/config.json ]; then
                        accelerate launch \
                        ...
                        --softcap=$softcap \
                        --output_dir=/work/jerry/output-softcap/$softcap/$reduction/$learning_rate/$NAME-$smoothing \
                        --dataset_mix_dir=/work/jerry/output-softcap/$NAME \
                        --reduce_loss=$reduction
                    else
                        echo "File '/work/jerry/output-softcap/$softcap/$reduction/$learning_rate/$NAME-$smoothing/config.json' already exists."
                    fi
                done
