        ...
        do
            ...
            do
                ...
                do
                    ...
                    if [ ! -f /work/jerry/output-softcap-alpaca/$softcap/$reduction/$learning_rate/$NAME-$smoothing/config.json ]; then
                        accelerate launch \
                        ...
                        --softcap=$softcap \
                        --output_dir=/work/jerry/output-softcap-alpaca/$softcap/$reduction/$learning_rate/$NAME-$smoothing \
                        --dataset_mix_dir=/work/jerry/output-softcap-alpaca/$NAME \
