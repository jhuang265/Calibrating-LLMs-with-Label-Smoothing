        ...
        do
            ...
            do
                ...
                do
                    ...
                    if [ ! -f /work/jerry/output-temperature/$temperature/$reduction/$learning_rate/$NAME-$smoothing/config.json ]; then
                        accelerate launch \
                        ...
                        --output_dir=/work/jerry/output-temperature/$temperature/$reduction/$learning_rate/$NAME-$smoothing \
                        --dataset_mix_dir=/work/jerry/output-temperature/$NAME \
                        --reduce_loss=$reduction
                    else
                        echo "File '/work/jerry/output-temperature/$temperature/$reduction/$learning_rate/$NAME-$smoothing/config.json' already exists."
                    fi
                done
