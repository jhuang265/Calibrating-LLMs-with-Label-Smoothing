        ...
        do
            ...
            do
                ...
                do
                    ...
                    if [ ! -f /mnt/nfs/node6/jerry/work/output-softcap-alpaca/$softcap/$reduction/$learning_rate/$NAME-$smoothing/config.json ]; then
                        accelerate launch \
                        ...
                        --softcap=$softcap \
                        --output_dir=/mnt/nfs/node6/jerry/work/output-softcap-alpaca/$softcap/$reduction/$learning_rate/$NAME-$smoothing \
                        --dataset_mix_dir=/mnt/nfs/node6/jerry/work/output-softcap-alpaca/$NAME \
                        --dataset_mixer='{"arazd/tulu_stanford_alpaca": 1.0}' \
                        --reduce_loss=$reduction \
                        --checkpointing_steps=250
                    else
                        echo "File '/work/jerry/output-softcap-alpaca/$softcap/$reduction/$learning_rate/$NAME-$smoothing/config.json' already exists."
                    fi
                done
