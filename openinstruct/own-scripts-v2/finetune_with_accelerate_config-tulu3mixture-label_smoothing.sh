    ...
    do
        ...
        do
            ...
            do
                ...
                if [ ! -f /mnt/nfs/node6/jerry/work/output/$reduction/$learning_rate/$NAME-$smoothing/config.json ]; then
                    accelerate launch \
                    ...
                    --output_dir=/mnt/nfs/node6/jerry/work/output/$reduction/$learning_rate/$NAME-$smoothing \
                    --dataset_mix_dir=/mnt/nfs/node6/jerry/work/output/$NAME \
                    --reduce_loss=$reduction
                else
                    echo "File '/mnt/nfs/node6/jerry/work/output/$reduction/$learning_rate/$NAME-$smoothing/config.json' already exists."
                fi
            done
