        ...
        do
            ...
            do
                ...
                do
                    ...
                    if [ ! -f /mnt/nfs/node6/jerry/work/output-temperature-alpaca/$temperature/$reduction/$learning_rate/$NAME-$smoothing/config.json ]; then
                        accelerate launch \
                        ...
                        --output_dir=/mnt/nfs/node6/jerry/work/output-temperature-alpaca/$temperature/$reduction/$learning_rate/$NAME-$smoothing \
                        --dataset_mix_dir=/mnt/nfs/node6/jerry/work/output-temperature-alpaca/$NAME \
